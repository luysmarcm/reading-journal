...
export const searchBooks = async (query) => {
  ...
  try {
    // CAMBIO AQUÍ: Ahora apuntamos a Open Library
    ...
    // Mapeamos los docs de Open Library al formato que tu Modal espera
    return data.docs.map((book) => ({
      ...
      volumeInfo: {
        ...
        coverId: book.cover_i, // Guardamos el ID para la portada
      },
    }));
  } catch (error) {
